-- =====================================================================
-- FIX v2 para Migration 06 — Corrige referências de evaluee_id
-- =====================================================================
-- O erro: "column 'employee_id' does not exist" em evaluations
-- Solução: evaluations usa 'evaluee_id', não 'employee_id'
--
-- Esta versão droppa as policies RLS antes de droppar as funções
-- =====================================================================

-- 1. Droppar as policies que dependem das funções
drop policy if exists "answers_select" on public.answers;

-- 2. Recriar função manager_can_see_self_eval com evaluee_id
...
-- 3. Recriar função finalize_manager_evaluation com evaluee_id
...
-- 4. Recriar função finalize_consensus com evaluee_id
...
-- 5. Recriar view v_consensus_side_by_side com evaluee_id
...
-- 6. Recriar a policy RLS answers_select que depende da função
